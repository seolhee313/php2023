                ...
                <form action="joinSave.php" name="join" method="post">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input type="password" id="youPass" name="youPass" class="inputStyle" placeholder="비밀번호를 적어주세요!" autocomplete="new-password" required>
                        </div>
                        <div>
                            <label for="youPassC" class="required">비밀번호 확인</label>
                            <input type="password" id="youPassC" name="youPassC" class="inputStyle" placeholder="다시 한번 비밀번호를 적어주세요!" autocomplete="new-password" required>
                        </div>
                        <div>
