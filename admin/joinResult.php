...
<body class="gray">
    ...
    <main id="main" class="container">
            ...
            <div class="border-animation">
                ...
                <defs>
                    ...
                    <g id="plane">
                        ...
                        <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB"> 회원가입을 축하합니다! </text>
        ...
        <div class="join__inner">
            ...
            <p class="intro__text1 container mt50">
                회원가입을 축하드립니다. 환영합니다.<br>
                로그인을 해주세요!
            </p>
            <button type="submit" class="btnStyle mt100">관리자 로그인</button>
        </div>
    </main>
    <!-- //main -->
